...
#from core.database import get_trainers_from_db  # Removed in favor of core.trainer.get_trainers
...
class AntiqueShopView(discord.ui.View):
    def __init__(self, user_id: str) -> None:
        super().__init__(timeout=None)
        self.user_id = user_id
        # Use get_trainers instead of the removed get_trainers_from_db
    ...
    async def shop_button(self, interaction: discord.Interaction, button: Button) -> None:
        # Open the generic shop view with "collection" as the shop name.
