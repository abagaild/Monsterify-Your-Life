...
import random
from logic import missions as logic_missions
from mainMenu import MainMenuView  # for returning to menu

from logic.missions import get_active_mission

# ----------------------------
# Mission View Components
# ----------------------------
# The view below uses the above mission logic. When a player accesses the missions interface,
# it first checks for an active mission (persistent in the database) and, if one exists, shows its progress.
# Otherwise, it shows the mission selection options.

MISSION_SELECT_IMAGE = "https://i.imgur.com/m8CtLFv.png"  # Replace with your actual image URL
...
# (The remainder of the view classes remains largely unchanged; they call the above logic functions.)
# For example, MissionsInterfaceView checks for an active mission and either shows mission progress
# or a selection dropdown, ensuring that once a mission is selected (and stored persistently),
# it is always shown until completed.
